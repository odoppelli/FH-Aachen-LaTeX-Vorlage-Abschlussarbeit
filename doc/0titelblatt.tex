\begin{titlepage}
	...
	\centering \begin{minipage}[t]{17cm}
		\centering \bfseries \large Lokalisierung von Unmanned Aerial Vehicles\\ im Urbanen Bereich
		\medskip
	\end{minipage}
	...
	\begin{minipage}[t]{9cm}
		\centering Oliver Kuipers \\ Matr.-Nr.: 3220368
	\end{minipage}
	...
	\centering \begin{minipage}[t]{9cm}
		\centering \begin{tabular}{ll}
			...
			Korreferent: & M.Sc. Lukas Hildebrand\\
